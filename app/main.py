...
def format_linter_error(error: dict) -> dict:
    return {**{new_key: error[old_key] for old_key, new_key in {"line_number": "line", "column_number": "column", "text": "message", "code": "name"}.items() if old_key in error}, "source": "flake8"}
